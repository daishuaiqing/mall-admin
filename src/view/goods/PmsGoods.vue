            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
                ...
                <FormItem label="市场价格" prop="originalPrice">
                    <InputNumber
                            ...
                            :parser="value => value.replace(/￥s?|(,*)/g, '')" style="width: 200px"/>
                </FormItem>
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    ...
                    categoryId: [
                        { required: true, type: 'number', message: '请选择商品所属类目', trigger: 'change' }
                    ],
                    isOnSale: [
                    ...
                    unit: [
                        { required: true, message: '请输入商品单位，例如件、盒', trigger: 'blur' }
                    ],
                    originalPrice: [
                        { required: true, type: 'number', message: '请输入市场价格', trigger: 'blur' }
                    ],
                    price: [
